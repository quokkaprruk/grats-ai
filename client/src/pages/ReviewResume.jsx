import { Eraser, FileText, Image, Sparkles } from "lucide-react";
  ...
  return (
    <div className="flex flex-col items-center gap-6 w-full px-4 mt-10">
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>Upload an image and click "Review Resume"</p>
            </div>
          </div>
        ) : (
      ...
      >
        ...
        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 mt-10 text-sm rounded-lg cursor-pointer"
        >
          {loading ? (
